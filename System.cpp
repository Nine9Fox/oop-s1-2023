...
void System::Initial()
{
    ...
    SCmanager.InitialScene_FinalPay();
...
{ 
    ...
    {
        //cout<<"Scene6"<<endl;
        SCmanager.drawScene_FinalPay(window);
    }
...
void System::Input_UserSearch()
{
    ...
    while (window.pollEvent(event))
    {
        ...
        SCmanager.BTmanager.TIB_maps["year_US"]->checkMouse(mousePosition,event);
        SCmanager.BTmanager.TIB_maps["month_US"]->checkMouse(mousePosition,event);
        SCmanager.BTmanager.TIB_maps["day_US"]->checkMouse(mousePosition,event);

        SCmanager.BTmanager.textInput_Input(event,"origin_US");
        SCmanager.BTmanager.textInput_Input(event,"destination_US");
        SCmanager.BTmanager.textInput_Input(event,"year_US");
        SCmanager.BTmanager.textInput_Input(event,"month_US");
        SCmanager.BTmanager.textInput_Input(event,"day_US");
