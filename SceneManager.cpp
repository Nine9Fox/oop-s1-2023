...
{   
    ...
    BTmanager.TIB_maps["origin_US"]->setPosition(200,200);
    BTmanager.TIBT_maps["origin_US"]->setPosition(200,200);
    BTmanager.TIB_maps["destination_US"]->setPosition(600,200);
    BTmanager.TIBT_maps["destination_US"]->setPosition(600,200);

    BTmanager.escape.setPosition((1618),0);
    BTmanager.search.setPosition(400,500);
    ...
    for(int i=0;i<10;i++)
    {
        if(BTmanager.flight[i]!=nullptr)
        {
            ...
            &&BTmanager.flight[i]->FBT_maps["destination_f"]->getString()==BTmanager.TIBT_maps["destination_US"]->getString())
            {
                ...
                if(j<3)
                {
                    BTmanager.flight[i]->set_Position(400*1,200*j+200);                   
                }
                if(j>=3&&j<6)
                {
                    BTmanager.flight[i]->set_Position(400*2,200*(j-3)+200); 
                }
                if(j>=6)
                {
                    BTmanager.flight[i]->set_Position(400*3,200*(j-6)+200); 
                }
                j++;
...
void SceneManager::InitialScene_AirLine()
{
    ...
    BTmanager.TIB_maps["month"]->setPosition(600,400);
    BTmanager.TIB_maps["day"]->setPosition(1000,400);
    ...
    BTmanager.TIBT_maps["origin"]->setPosition(200,200);
    BTmanager.TIBT_maps["destination"]->setPosition(600,200);
    BTmanager.TIBT_maps["num"]->setPosition(400,200);    
    BTmanager.TIBT_maps["month"]->setPosition(600,400);
    BTmanager.TIBT_maps["day"]->setPosition(1000,400);
    BTmanager.TIBT_maps["year"]->setPosition(200,400);
    BTmanager.TIBT_maps["price"]->setPosition(600,600);
    BTmanager.TIBT_maps["o_time"]->setPosition(200,600);
    BTmanager.TIBT_maps["f_time"]->setPosition(400,600);
